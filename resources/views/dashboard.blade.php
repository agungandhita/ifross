            ...
            <div class="lg:col-span-1 space-y-4">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-900">{{ App\Models\Service\Service::count() }}</h4>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-900">{{ App\Models\Service\Package::count() }}</h4>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-900">{{ App\Models\Portfolio\Portfolio::count() }}</h4>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-900">{{ App\Models\Portfolio\Testimonial::count() }}</h4>
                    </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden h-full flex flex-col">
                    ...
                    <div class="flex-1 overflow-x-auto">
                        @php
                            $recentPortfolios = App\Models\Portfolio\Portfolio::latest('created_at')->take(5)->get();
                        @endphp
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition-colors">
                                            <td class="py-4 px-6">
                                                <div class="flex items-center gap-3">
                                                    @if($portfolio->first_image)
                                                        <img src="{{ Storage::url($portfolio->first_image) }}" alt="{{ $portfolio->title }}" class="w-10 h-10 rounded-md object-cover">
                                                    @else
                                            ...
                                            <td class="py-4 px-6 text-center">
                                                @if($portfolio->is_active)
                                                    <span class="inline-flex w-3 h-3 bg-green-500 rounded-full" title="Aktif"></span>
                                                @else
                                                    <span class="inline-flex w-3 h-3 bg-gray-300 rounded-full" title="Nonaktif"></span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
